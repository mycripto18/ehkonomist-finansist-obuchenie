                        ...
                        <div className="space-y-4 p-4">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              ...
                              <Input value={course.format} onChange={(e) => updateCourse(index, 'format', e.target.value)} />
                            </div>
                            <div>
                              <label className="block text-sm font-medium mb-2">Длительность</label>
                              <Input value={course.duration} onChange={(e) => updateCourse(index, 'duration', e.target.value)} />
                            </div>
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                              ...
                              <Input value={course.forWhom} onChange={(e) => updateCourse(index, 'forWhom', e.target.value)} />
                            </div>
                          </div>
